 ...
 * @method
 */
Player.prototype.resetStats = function(hardReset = false) {
  this._moves = 0;
  this._matches = 0;
 ...
 * @method
 */
Player.prototype.getNumberMatches = function() {
 ...
 * @method
 */
Player.prototype.getNumberMoves = function() {
  return this._moves;
};
 ...
 * @method
 */
Player.prototype.getStars = function() {
  return this._stars;
};
 ...
 * @method
 */
Player.prototype.haveStarsChanged = function() {
 ...
 * @method
 */
Player.prototype.setMismatched = function() {
  this._moves++;
 ...
 * @method
 */
Player.prototype.setMatched = function() {
  this._moves++;
  this._matches++;
  ...
  if (this._consecutiveMatches >= this._config.thresholds.consecutiveMatch) {
    this._score += this._config.scoring.consecutiveMatch *
        this._consecutiveMatches;
  }

  // Once player reaches the bonus round, award the progressive bonus points.
  if (this._consecutiveMatches >=
      this._config.thresholds.consecutiveMatchBonus) {
    this._score += this._config.scoring.consecutiveMatchBonus *
        (this._config.thresholds.consecutiveMatchBonus -
